...
def test_stream_status_event():
    ...
    assert_equals(
        ...
        'dc34og3c3aqdqntblnxkstzfvh7iy7llojd4fi5j23y2po32ock2k7ad.anon:0.0.0.0:8080'
    )
    assert_equals(stream.stream_id, '4:12:localhost:127.0.0.1:46878:dc34og3c3aqdqntblnxkstzfvh7iy7llojd4fi5j23y2po32ock2k7ad.anon:0.0.0.0:8080')
...
def test_stream_object_init():
    ...
    assert_equals(s.id, '4:12:localhost:127.0.0.1:46878:dc34og3c3aqdqntblnxkstzfvh7iy7llojd4fi5j23y2po32ock2k7ad.anon:0.0.0.0:8080')
    ...
    assert_equals(
        s.get_data(), {
            ...
            'transport_info': {'fd': '12',
                ...
                'remote': 'dc34og3c3aqdqntblnxkstzfvh7iy7llojd4fi5j23y2po32ock2k7ad.anon:0.0.0.0:8080',
                'state': 'ERROR',
                'error': 'READ'},
            'stream_info': {
                'id': '4',
            ...
            'stream_id': '4:12:localhost:127.0.0.1:46878:dc34og3c3aqdqntblnxkstzfvh7iy7llojd4fi5j23y2po32ock2k7ad.anon:0.0.0.0:8080',
